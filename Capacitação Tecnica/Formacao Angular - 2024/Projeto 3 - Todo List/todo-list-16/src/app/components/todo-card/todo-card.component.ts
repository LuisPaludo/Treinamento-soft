...
import { TodoKeyLocalStorage } from 'src/app/models/enum/todoKeyLocalStorage.enum';
...
export class TodoCardComponent implements OnInit {
  ...
  public getTodosInLocalStorage(): void {
  ...
  public savesTodosInLocalStorage():void {
